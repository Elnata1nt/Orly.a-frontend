      ...
      <div className="container px-4 md:px-6 relative">
        ...
        >
          ...
          <p className="max-w-[800px] text-muted-foreground md:text-lg">
            Comece em minutos e veja a diferença que nossa plataforma pode fazer para o seu negócio.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description:
                "Cadastre-se em segundos e conecte suas contas bancárias ou comece a registrar suas transações manualmente.",
            },
            {
              step: "02",
              title: "Organize suas Finanças",
              description:
                "Categorize seus gastos e ganhos automaticamente e personalize seu painel conforme suas necessidades.",
            },
            {
              step: "03",
              title: "Economize com Inteligência",
              description:
                "Receba insights personalizados e sugestões de economia baseadas no seu comportamento financeiro.",
            },
          ].map((step, i) => (
            <motion.div
              key={i}
