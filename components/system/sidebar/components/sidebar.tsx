...
import { BarChart3, FileText, Wallet, PieChart, Target, Users, Settings, LogOut, MessageCircle } from "lucide-react"
...
// Export the sidebar state and toggle function
...
export default function Sidebar({ open }: SidebarProps) {
  return (
    <div
      className={cn(
        "fixed inset-y-0 left-0 z-40 lg:w-64 w-84 transform border-r bg-background/95 backdrop-blur-sm transition-transform duration-200 ease-in-out md:translate-x-0",
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex-1 overflow-auto py-4 px-4">
          ...
          <Section title="Equipe">
            <div className="px-3 py-2 text-xs text-muted-foreground">Pessoas com permissão de acesso à plataforma.</div>
